 ...
 */
public class ChartSocialDistance extends Application {
    ...
    public void showChartWithSocialDisatnce( double r_factor, int no_of_infected, int no_of_immune,
...
// AreaChart Data
        ...
        lineChart.setTitle("CoronaVirus Social Distance Chart");
        //defining a series
