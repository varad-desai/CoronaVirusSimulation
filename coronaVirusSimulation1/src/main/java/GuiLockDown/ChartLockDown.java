...
public class ChartLockDown extends Application {
    ...
    public void showChartWithLockDown(double r_factor, int no_of_infected, int no_of_immune,
...
// AreaChart Data
        ...
        areaChart.setTitle("CoronaVirus Lock Down chart");
        //defining a series
